...
🟢 Nele temos o módulo http, que nos permite criar um servidor http usando a função 'createServer() + a função listen()', dentro de ambos passamos: pro create server a requisição e a resposta, e pro listen a porta que ele vai usar da internet pra rodar, no caso a porta selecionada é a 8081. <br>
...
🟢 Nos parâmetros de rotas e nas queries, são partes da URL q serão usados para pegar as informações de cada um, nas rotas temos o GET, PUT, POST E DELETE. <br><br>
